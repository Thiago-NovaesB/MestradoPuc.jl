...
@testset "Simplex" begin
    ...
    @testset "10 variables" begin
        ...
        @test output.x == [0.021665538253215974, 0.0, 0.07752200406228843, 0.0, 0.0, 0.0, 0.0, 0.04570074475287744, 0.0, 0.0, 8.20514556533514, 6.321259309410968, 21.437711577522006, 19.794515910629656, 20.410291130670277, 0.0, 13.41198375084631, 0.0, 0.3706838185511172, 0.0]
        @test output.z == 1.052132701421801
        @test output.termination_status == 1
        @test output.base == [11, 12, 13, 14, 15, 8, 17, 1, 19, 3]
        @test output.nbase == [6, 2, 20, 4, 18, 5, 7, 16, 9, 10] 
    end
    ...
    @testset "Cicle" begin
        ...
        @test output.x == [6.0, 4.0, 0.0, 14.0, 0.0]
        @test output.z == 34.0
        @test output.termination_status == 1
        @test output.base == [2, 4, 1]
        @test output.nbase == [5, 3]  
